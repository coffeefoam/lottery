...
public class LotteryConstant {
	...
	public static final Map<String, String> lotteryJqCategoryMap;//资讯技巧分类map
	...
	static {
		...
		// lotteryColumnStrMap.put("pcdd",
		// "num1,num2,num3,num4,num5,num6,num7,num8,num9,num10");//pc蛋蛋暂时没有所以先注释掉
		lotteryColumnStrMap.put("kl8",
				"num1,num2,num3,num4,num5,num6,num7,num8,num9,num10,num11,num12,num13,num14,num15,num16,num17,num18,num19,num20,num21");
		...
		// lotteryTotalPeriodMap.put("pcdd", 3);
		...
		/*lotteryClurlMap.put("jsk", "jsk3");
		lotteryClurlMap.put("kl8", "kl8");*/
		//江西11x5
		...
		lotteryJqCategoryMap = new HashMap<String, String>();
		lotteryJqCategoryMap.put("bjsc", "pk10");
		lotteryJqCategoryMap.put("cqssc", "shishicai");
		lotteryJqCategoryMap.put("gd11x5", "gd11x5");
		lotteryJqCategoryMap.put("jx11x5", "jx11x5");
		lotteryJqCategoryMap.put("gdklsf", "gdkl10");
		lotteryJqCategoryMap.put("xyft", "xyft");
		lotteryJqCategoryMap.put("xync", "xync");
		// tableNameMap.put("sdc", "t_bs_sdc");//圣地彩暂时没有所以先注释掉
		lotteryJqCategoryMap.put("tjssc", "tjssc");
		lotteryJqCategoryMap.put("xjssc", "xjssc");
		lotteryJqCategoryMap.put("jsk3", "jsk3");
		// tableNameMap.put("pcdd", "t_bs_pcdd");//pc蛋蛋暂时没有所以先注释掉
		lotteryJqCategoryMap.put("kl8", "kl8");
		lotteryJqCategoryMap.put("pcdd", "pcdd");
	}
}
