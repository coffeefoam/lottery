...
(function () {
    ...
    var url3=window.parent.location.protocol+"//"+window.parent.location.host+window.parent.location.pathname;
    
    url3 = url3.substring(0, url3.lastIndexOf("/")) + "/ueditor/config";
